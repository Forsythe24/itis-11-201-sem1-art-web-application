...
<div class="list-group" id="list" style="margin-top: 5.5rem">
    <a class= "list-group-item list-group-item-action flex-column">
        ...
        <span class="mb-1" style="font-size: 25px;">— Be mindful when it comes to your words. A string of some that <span class="text-muted text-end" style="margin-left: 1.0rem"><i>Rachel Wolchin</i></span>
        </span>
    </a>
</div>

<script src="scripts/get-reading-list.js"></script>
<script>
